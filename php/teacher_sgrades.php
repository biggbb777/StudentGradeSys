        ...
        <tbody>
          <?php
            ...
            if(isset($_POST['search_grade'])){
              $url='http://'. $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/teacher_search_student_grade.php';
              header('Location:'.$url);
            }
            if(isset($_POST['insert_grades'])){
              $url='http://'. $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/teacher_insert_grades.php';
              header('Location:'.$url);
            }
          ?>
        </tbody>
